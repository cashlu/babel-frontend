<template>
    <div id="proofread">
        ...
        <el-card class="box-card">
            ...
            <el-button type="warning" @click="proofreadTransient()" style="font-weight: bold">暂 存</el-button>
            <el-button type="danger" @click="proofreadBack()" style="font-weight: bold">打 回</el-button>
            <el-button type="primary" @click="proofreadSubmit()" style="font-weight: bold">通 过</el-button>
        </el-card>
...
export default {
    ...
    methods: {
        ...
        async saveCheckRecord(status) {
            ...
            this.proofreadForm.status = status
            this.proofreadForm.basicInfo = this.basicInfo.id
            // 审批人为当前的登录用户

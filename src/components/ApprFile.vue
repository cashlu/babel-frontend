<template>
    <div>
        ...
        <el-dialog
                title="查看鉴定材料"
                :close-on-click-modal="false"
                @close="showApprFileDialogVisible=false"
            ...
            <el-form ref="editApprFileFormRef"
                ...
                <el-row :gutter="10">
                    <el-col :span="18">
                        <el-form-item label="材料名称" prop="name">
                            <el-input disabled v-model="showApprFileForm.name" placeholder="请输入"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="数量" prop="quantity">
                            <!-- 如果要做数字的表单验证，这里要绑定为v-model.number -->
                            <el-input disabled v-model.number="showApprFileForm.quantity"
